...
---
---😱 [Types](https://github.com/TeXLuaCATS/LuaTeX/blob/main/library/sha2.lua) incomplete or incorrect? 🙏 [Please contribute!](https://github.com/TeXLuaCATS/LuaTeX/pulls)
sha2 = {}

...
---@return string
---
---😱 [Types](https://github.com/TeXLuaCATS/Lualibs/blob/main/library/string.lua) incomplete or incorrect? 🙏 [Please contribute!](https://github.com/TeXLuaCATS/Lualibs/pulls)

...
---@return table
---
---😱 [Types](https://github.com/TeXLuaCATS/Lualibs/blob/main/library/table.lua) incomplete or incorrect? 🙏 [Please contribute!](https://github.com/TeXLuaCATS/Lualibs/pulls)
